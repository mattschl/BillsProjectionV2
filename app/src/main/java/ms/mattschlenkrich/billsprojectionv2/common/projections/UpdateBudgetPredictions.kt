...
class UpdateBudgetPredictions(
    ...
    private var budgetRuleViewModel = mainActivity.budgetRuleViewModel
    private var budgetItemViewModel = mainActivity.budgetItemViewModel
    ...
    private fun updateBudgetItemsFallingOnPaydays(
        rulesOnPayDay: ArrayList<BudgetRule>,
        stopDate: String,
        payDays: List<String>
    ) {
    ...
    private suspend fun updateAllOtherBudgetItems(
        rulesOther: ArrayList<BudgetRule>,
        stopDate: String,
        waitTime: Long
    ) {
        coroutineScope {
