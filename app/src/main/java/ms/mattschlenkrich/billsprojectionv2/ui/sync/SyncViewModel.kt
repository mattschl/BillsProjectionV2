...
class SyncViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun syncAccountTypes(
        appDb: BillsDatabase,
        backupDb: SQLiteDatabase
    ): Pair<Int, Int> {
        return syncTable(
    ...
    private suspend fun syncBudgetRules(
        appDb: BillsDatabase,
        backupDb: SQLiteDatabase
    ): Pair<Int, Int> {
        return syncTable(
    ...
    private suspend fun syncBudgetItems(
        appDb: BillsDatabase,
        backupDb: SQLiteDatabase
    ): Pair<Int, Int> {
        return syncTable(
    ...
    private suspend fun syncSyncHistory(
        appDb: BillsDatabase,
        backupDb: SQLiteDatabase
    ): Pair<Int, Int> {
        return syncTable(
